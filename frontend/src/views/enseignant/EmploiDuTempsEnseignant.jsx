  ...
  return (
    <div>
      <div style={{ marginBottom: 24 }}>
        <h2 style={{ fontSize: 24, fontWeight: 'bold', color: '#0b3d91', margin: '0 0 4px' }}>Mon Emploi du temps</h2>
        <p style={{ color: '#6b7280', margin: 0 }}>{emploi.length} cours programmés cette semaine</p>
      </div>
